      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-6 max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
            ...
            <div className="border-b pb-4">
                <h4 className="font-semibold text-gray-700 mb-3">Auto-Save</h4>
                <div>
                    <label htmlFor="setting-autosave-delay" className="block text-sm font-medium text-gray-700 mb-1">Auto-Save Delay (seconds)</label>
                    <input 
                        id="setting-autosave-delay"
                        name="setting-autosave-delay"
                        type="number" 
                        min="1" 
                        max="60" 
                        value={(localConfig.autoSaveDelay || 10000) / 1000} 
                        onChange={(e) => handleChange('autoSaveDelay', parseInt(e.target.value) * 1000)}
                        className="w-full border rounded-md p-2"
                    />
                    <p className="text-xs text-gray-500 mt-1">Delay before auto-saving after changes (1-60 seconds).</p>
                </div>
            </div>

            {/* MindAR Settings */}
            <div>
                <h4 className="font-semibold text-gray-700 mb-3">MindAR Configuration</h4>
