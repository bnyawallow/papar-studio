...
export class StoreWriter {
  ...
  public writeToStore({
    ...
    const ref = this.processSelectionSet({
      ...
      context: {
// Fix: Object literal may only specify known properties, and 'store' does not exist in type 'WriteContext'.
        store,
...
// Fix: Property 'variables' does not exist on type 'WriteContext'.
...
// Fix: Argument of type 'SelectionNode' is not assignable to parameter of type 'FieldNode'.
            this.processFieldValue(value, selection as FieldNode, context, childTree);

// Fix: Property 'selectionSet' does not exist on type 'SelectionNode'.
          const childTypename = (selection as FieldNode).selectionSet
// Fix: Property 'store' does not exist on type 'WriteContext'.
...
// Fix: Property 'selectionSet' does not exist on type 'SelectionNode'.
        ...
        workSet.forEach(selection => {
// Fix: Property 'name' does not exist on type 'SelectionNode'.
          if (isField(selection) && (selection as FieldNode).selectionSet) {
            fieldsWithSelectionSets.add((selection as FieldNode).name.value);
          }
        });
