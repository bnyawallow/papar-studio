...
// Fix: Module '"../cache"' has no exported member 'DataProxy'.
import { ApolloCache, DataProxy } from '../cache/index';
...
// Fix: Property 'variables' does not exist on type 'TOptions'.
  return compact(defaults, options, (options as any).variables && {
    variables: {
// Fix: Property 'variables' does not exist on type 'Partial<TOptions>'.
      ...(defaults as any).variables,
// Fix: Property 'variables' does not exist on type 'TOptions'.
